...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="programe.php">
            <button type="button" class="d-sm-inline-block btn btn-sm btn-success shadow-sm mt-2" style="text-transform:capitalize;" ><i class='fas fa-fw fa-plus'></i> Program</button>
        </a>
        
        <a href="ubah_header.php?nav=program">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <button type="submit" name="tambah_kegiatan" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm mt-2"><i class='fas fa-fw fa-plus'></i> Tambahkan</button>
                </form>
            </div>
        </div>
...
$queryz=mysqli_query($con,"SELECT * FROM galeri WHERE judul='0' ORDER BY id DESC");
while($hasilz= mysqli_fetch_array($queryz)){
    ...
    <a href='aksi.php?aksi=hapus_kegiatan&id=$hasilz[id]' onclick='return checkDelete()'>
    <center>
